...
def resnet50_model(img_rows, img_cols, color_type=1, num_classes=None):
    base_model = ResNet50(weights = "../weight/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5", include_top = False, pooling = 'avg')
    x = Dense(5, activation='softmax')(base_model.output)
...
def resnet101_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    weights_path = "../weight/resnet101_weights_tf.h5"
...
def resnet152_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    weights_path = "../weight/resnet152_weights_tf.h5"
    model.load_weights(weights_path, by_name=True)
