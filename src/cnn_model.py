...
def naivecnn_model(img_rows, img_cols, channel=1, num_classes=None):
    #model naive CNN
    model = Sequential()
    model.add(Conv2D(filters = 32, kernel_size = (5,5),padding = 'Same',activation ='relu', input_shape = (img_rows,img_cols,channel)))
...
def vgg16_model(img_rows, img_cols, channel=1, num_classes=None):
    ...
    model.load_weights('../weight/vgg16_weights_tf.h5')
...
def vgg19_model(img_rows, img_cols, channel=1, num_classes=None):
    ...
    # Loads ImageNet pre-trained data
    model.load_weights('../weight/vgg19_weights_tf.h5')
